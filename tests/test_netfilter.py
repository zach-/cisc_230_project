...
[935044:68004850] -A firewall_input_filter -i eth0.161 -p udp -m multiport --dports 53,67 -j ACCEPT
[216374:11435810] -A firewall_input_filter -i eth0.161 -p tcp -m multiport --dports 8089,8090 -j ACCEPT
[141:9420] -A firewall_input_filter -i eth0.161 -p tcp -m multiport --dports 5222,7777,8080 -j ACCEPT
[652708:44603726] -A firewall_input_filter -i eth0.171 -p udp -m multiport --dports 53,67 -j ACCEPT
[82187:4331634] -A firewall_input_filter -i eth0.171 -p tcp -m multiport --dports 8089,8090 -j ACCEPT
[125:9171] -A firewall_input_filter -i eth0.171 -p tcp -m multiport --dports 5222,7777,8080 -j ACCEPT
COMMIT
# Completed
"""
